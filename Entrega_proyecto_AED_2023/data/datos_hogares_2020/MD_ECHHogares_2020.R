#################################################################################
# Nombre del programa:	MD_ECHHogares_2020.R                                          
# Autor:              	INE
# Version:            	4.1
# ?ltima modificaci?n: 	15 septiembre 2017
#                                                                                
# Descripci?n: 
#	Este programa procesa un fichero de microdatos (md_ECHHogares_2020.txt)
#   a partir de un fichero de metadatos (dr_ECHHogares_2020.xlsx) que contiene 
#   el dise?o de registro del archivo de microdatos. 
#     ECHHogares.: Operaci?n estad?stica
#     2020: A?o(s) de producci?n de los datos
#
# Entrada:                                                           
#     - Dise?o de registro: 	dr_ECHHogares_2020.xlsx
#     - Archivo de microdatos: 	md_ECHHogares_2020.txt
# Salida: 
#     - Archivo de microdatos en formato data.frame de R: fichero_salida 
#                                                                                
#################################################################################

options("MD_ECHHogares_2020.R", encoding = "utf-8")
...
fichero_micro <- "md_ECHHogares_2020.txt"
fichero_meta  <- "dr_ECHHogares_2020.xlsx"
